...
public class LoginUsuario extends javax.swing.JDialog {
 ...
 String sql = "select * from usuario where Nome_Usuario = ? and senha = ?";
   ...
   try{
          ...
          String captura = new String(jTextFieldSenha.getText());
          ...
          if(rs.next()){
         HomeUsuario objHomeUser = new HomeUsuario();
         objHomeUser.setVisible(true);
          }
          else{
           JOptionPane.showMessageDialog(null, "Usuario ou/e senha inválido(s)!");
          }
   }catch(Exception e){
